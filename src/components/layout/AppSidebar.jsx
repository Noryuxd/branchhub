  ...
  return (
    <nav className="inline-flex flex-col text-center mt-12 gap-6 text-gray-600">
      <Link
        href={"/account"}
        className={
          "flex gap-4 p-1 " + (path === "/account" ? "text-violet-800 " : " ")
        }
      >
        <FontAwesomeIcon
          fixedWidth={true}
      ...
      <Link
        href={"/analytics"}
        className={
          "flex gap-4 p-1 " + (path === "/analytics" ? "text-violet-800 " : " ")
        }
      >
        <FontAwesomeIcon
          fixedWidth={true}
      ...
      <Link
        href={"/"}
        className="flex gap-4 p-1 items-center text-gray-400 border-t pt-4"
      >
